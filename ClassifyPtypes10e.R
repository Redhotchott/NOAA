...
# in the training set. To keep the most balanced, I am using 
# for each training set the total number of the IP observations available. 
# so each training set is of length 4*(length(ptype.temp=='IP'))
#  0.908743200185293 Accuracy! WHEEEEE! Still no correctly class. IP's 
# Only temp as input
